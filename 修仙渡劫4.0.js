...
export class UltimateCultivation extends plugin {
  constructor() {
    super({
      ...
      rule: [
        ...
        { reg: '^#宗门管理\\s+(公告|解散|升级|传位)\\s*(.*)$', fnc: 'sectManagement', permission: 'master' },
    ...
    // 灵根资质系统
    this.spiritRoots = [
      { id: 0, name: "废灵根", expRate: 0.5, alchemy: 0.3, breakthrough: 0.4, tribulation: 0.4 },
      { id: 1, name: "伪灵根", expRate: 0.7, alchemy: 0.5, breakthrough: 0.6, tribulation: 0.5 },
      { id: 2, name: "下品灵根", expRate: 0.9, alchemy: 0.7, breakthrough: 0.8, tribulation: 0.6 },
      { id: 3, name: "中品灵根", expRate: 1.0, alchemy: 0.9, breakthrough: 1.0, tribulation: 0.7 },
      { id: 4, name: "上品灵根", expRate: 1.2, alchemy: 1.1, breakthrough: 1.2, tribulation: 0.8 },
      { id: 5, name: "地灵根", expRate: 1.5, alchemy: 1.3, breakthrough: 1.4, tribulation: 0.9 },
      { id: 6, name: "天灵根", expRate: 1.8, alchemy: 1.5, breakthrough: 1.6, tribulation: 1.0 },
      { id: 7, name: "圣灵根", expRate: 2.0, alchemy: 1.8, breakthrough: 1.8, tribulation: 1.2 },
      { id: 8, name: "仙灵根", expRate: 2.5, alchemy: 2.0, breakthrough: 2.0, tribulation: 1.5 },
      { id: 9, name: "混沌灵根", expRate: 3.0, alchemy: 2.5, breakthrough: 2.5, tribulation: 2.0 }
    ];
    
    // 丹药系统
    this.pills = [
      { id: 1, name: "聚气丹", effect: "exp:100", cost: 50, desc: "增加100点修为", quality: 1, type: "cultivation" },
      { id: 2, name: "筑基丹", effect: "breakthrough:15", cost: 300, desc: "增加突破成功率15%", quality: 2, type: "breakthrough" },
      { id: 3, name: "凝金丹", effect: "exp:2000", cost: 1500, desc: "增加2000点修为", quality: 3, type: "cultivation" },
      { id: 4, name: "元婴丹", effect: "exp:10000", cost: 8000, desc: "增加10000点修为", quality: 4, type: "cultivation" },
      { id: 5, name: "渡劫丹", effect: "tribulation:20", cost: 50000, desc: "增加渡劫成功率20%", quality: 5, type: "tribulation" },
      { id: 6, name: "九转还魂丹", effect: "revive", cost: 100000, desc: "渡劫失败保命", quality: 6, type: "special" },
      { id: 7, name: "九转金丹", effect: "exp:500000", cost: 300000, desc: "大幅提升修为", quality: 7, type: "cultivation" },
      { id: 8, name: "太虚神丹", effect: "spirit_root", cost: 500000, desc: "永久提升灵根资质", quality: 8, type: "special" },
      { id: 9, name: "生生造化丹", effect: "life:50", cost: 2000, desc: "恢复50点生命", quality: 3, type: "recovery" },
      { id: 10, name: "悟道丹", effect: "comprehension:0.5", cost: 10000, desc: "提升悟性0.5", quality: 4, type: "special" }
    ];
    
    // 功法系统
    this.arts = [
      { id: 1, name: "《基础吐纳诀》", effect: "expRate:1.1", level: 1, cost: 0, desc: "基础修炼功法" },
      { id: 2, name: "《五行道法》", effect: "breakthrough:1.15", level: 2, cost: 500, desc: "提升突破成功率" },
      { id: 3, name: "《九天玄功》", effect: "expRate:1.3, alchemy:1.2", level: 3, cost: 2000, desc: "提升修炼和炼丹效率" },
      { id: 4, name: "《太虚剑意》", effect: "tribulation:1.2", level: 4, cost: 5000, desc: "增强渡劫能力" },
      { id: 5, name: "《大衍神诀》", effect: "expRate:1.5, luck:10", level: 5, cost: 10000, desc: "提升修炼效率和气运" },
      { id: 6, name: "《混沌经》", effect: "expRate:2.0, breakthrough:1.3", level: 6, cost: 50000, desc: "顶级修炼功法" },
      { id: 7, name: "《星辰变》", effect: "all:1.25", level: 7, cost: 100000, desc: "全面提升属性" },
      { id: 8, name: "《一气化三清》", effect: "expRate:2.5, tribulation:1.5", level: 8, cost: 500000, desc: "无上仙法" },
      { id: 9, name: "《不死神凰诀》", effect: "life:50, revive:1", level: 9, cost: 300000, desc: "增加生命和复活机会" },
      { id: 10, name: "《虚空经》", effect: "dungeon:1.3, adventure:1.5", level: 10, cost: 200000, desc: "增强秘境和奇遇收益" }
    ];
    
    // 法宝系统
    this.artifacts = [
      { id: 1, name: "青锋剑", effect: "突破成功率+5%", level: 1, cost: 500, type: "weapon", attr: "breakthrough:5" },
      { id: 2, name: "玄武盾", effect: "天劫伤害-10%", level: 2, cost: 1500, type: "armor", attr: "tribulation:10" },
      { id: 3, name: "神农鼎", effect: "炼丹成功率+15%", level: 3, cost: 5000, type: "tool", attr: "alchemy:15" },
      { id: 4, name: "昆仑镜", effect: "奇遇触发率+20%", level: 4, cost: 20000, type: "mystic", attr: "adventure:20" },
      { id: 5, name: "东皇钟", effect: "全属性+15%", level: 5, cost: 100000, type: "divine", attr: "all:15" },
      { id: 6, name: "诛仙剑阵", effect: "攻击类法宝效果翻倍", level: 6, cost: 500000, type: "weapon", attr: "weapon_effect:100" },
      { id: 7, name: "炼妖壶", effect: "秘境收益+30%", level: 5, cost: 80000, type: "tool", attr: "dungeon:30" },
      { id: 8, name: "伏羲琴", effect: "双修效果+50%", level: 4, cost: 30000, type: "mystic", attr: "dual:50" },
      { id: 9, name: "盘古斧", effect: "突破成功率+20%", level: 7, cost: 300000, type: "weapon", attr: "breakthrough:20" },
      { id: 10, name: "女娲石", effect: "生命上限+30%", level: 6, cost: 150000, type: "divine", attr: "life:30" }
    ];
    
    // 秘境系统
    this.dungeons = [
      { id: 1, name: "迷雾森林", minRealm: 0, rewards: "灵石+100~300，修为+50~150", difficulty: "简单" },
      { id: 2, name: "熔岩洞穴", minRealm: 4, rewards: "灵石+300~800，修为+200~500，低阶丹药", difficulty: "普通" },
      { id: 3, name: "幽冥地府", minRealm: 8, rewards: "灵石+1000~3000，修为+800~2000，中阶丹药", difficulty: "困难" },
      { id: 4, name: "九天仙宫", minRealm: 12, rewards: "灵石+5000~15000，修为+3000~8000，高阶丹药", difficulty: "极难" },
      { id: 5, name: "混沌虚空", minRealm: 20, rewards: "极品法宝，仙丹，稀有功法", difficulty: "地狱" }
    ];
    
    // 天劫系统
    this.tribulations = [
      { id: 1, name: "三九天劫", damage: 30, desc: "三重雷劫，每重九道天雷", level: 1, successRate: 60 },
      { id: 2, name: "六九天劫", damage: 50, desc: "六重雷劫，每重九道天雷", level: 2, successRate: 50 },
      { id: 3, name: "九九天劫", damage: 70, desc: "九重雷劫，每重九道天雷", level: 3, successRate: 40 },
      { id: 4, name: "心魔劫", damage: 40, desc: "引动心魔，道心不稳者极易陨落", level: 4, successRate: 45 },
      { id: 5, name: "业火劫", damage: 60, desc: "红莲业火焚身，净化因果业力", level: 5, successRate: 35 },
      { id: 6, name: "混沌劫", damage: 90, desc: "混沌神雷，毁天灭地", level: 6, successRate: 25 }
    ];
    
    // 商店物品
    this.shopItems = [
      { id: 1, name: "下品灵石袋", price: 100, effect: "stone:500", type: "resource", limit: 5 },
      { id: 2, name: "中品灵石袋", price: 500, effect: "stone:2500", type: "resource", limit: 3 },
      { id: 3, name: "上品灵石袋", price: 2000, effect: "stone:10000", type: "resource", limit: 1 },
      { id: 4, name: "聚气丹", price: 80, effect: "item:1", type: "pill", limit: 10 },
      { id: 5, name: "筑基丹", price: 400, effect: "item:2", type: "pill", limit: 5 },
      { id: 6, name: "炼器材料包", price: 300, effect: "refine:1", type: "material", limit: 3 },
      { id: 7, name: "气运符", price: 1500, effect: "luck:20", type: "buff", limit: 2 },
      { id: 8, name: "悟道茶", price: 2500, effect: "comprehension:1", type: "buff", limit: 1 },
      { id: 9, name: "宗门建设令", price: 5000, effect: "sect_exp:1000", type: "sect", limit: 1 },
      { id: 10, name: "随机功法卷轴", price: 10000, effect: "random_art", type: "special", limit: 1 }
    ];
    ...
    // 宗门任务
    this.sectMissions = [
      { id: 1, name: "采集灵草", requirement: "collect_herb", reward: "贡献+50, 灵石+200", difficulty: "简单" },
      { id: 2, name: "剿灭妖兽", requirement: "kill_monster", reward: "贡献+100, 灵石+500", difficulty: "普通" },
      { id: 3, name: "守卫矿脉", requirement: "defend_mine", reward: "贡献+200, 灵石+1000", difficulty: "困难" },
      { id: 4, name: "探索遗迹", requirement: "explore_ruin", reward: "贡献+500, 灵石+3000, 随机丹药", difficulty: "极难" },
      { id: 5, name: "炼制法宝", requirement: "forge_artifact", reward: "贡献+1000, 灵石+8000, 宗门经验+500", difficulty: "地狱" }
    ];
  ...
  saveData() {
    ...
    fs.writeFileSync(this.battleLogFile, JSON.stringify(this.battleLogs, null, 2));
  }
  ...
  async dailySign() {
    ...
    const lastSignDate = user.lastSign ? new Date(user.lastSign).toDateString() : null;
  ...
  async cultivate() {
    ...
    if (now - user.lastCultivate < 60 * 1000) {
      const remaining = Math.ceil((60 * 1000 - (now - user.lastCultivate)) / 1000);
  ...
  async adventure() {
    ...
    if (now - user.lastAdventure < 30 * 60 * 1000) {
      const remaining = Math.ceil((30 * 60 * 1000 - (now - user.lastAdventure)) / 60000);
    ...
    const events = [
      ...
      },
      {
        ...
        effect: (user) => {
          ...
          return `🌿 发现灵药园，获得 ${this.pills.find(p => p.id === pillId).name} ×${pillCount}`;
        }
      },
      {
        name: "前辈传承",
  ...
  async challengeDungeon() {
    ...
    if (now - user.lastDungeon < 30 * 60 * 1000) {
      const remaining = Math.ceil((30 * 60 * 1000 - (now - user.lastDungeon)) / 60000);
    ...
    if (!dungeon) {
      return this.reply(`❌ 秘境层级 ${dungeonLevel} 不存在，可用层级：1-${this.dungeons.length}`);
    }
    
    if (user.realm < dungeon.minRealm) {
      return this.reply(`❌ 境界不足！需要 ${this.realms[dungeon.minRealm]} 才能挑战 ${dungeon.name}`);
    }
    ...
    if (success) {
      ...
      if (Math.random() < 0.3) {
        ...
        if (pillId <= this.pills.length) {
          ...
          if (!user.pills[pillId]) user.pills[pillId] = 0;
          user.pills[pillId] += pillCount;
          resultMsg.push(`💊 额外获得：${this.pills[pillId-1].name} ×${pillCount}`);
        }
      }
  ...
  async artifactRefining() {
    ...
    if (now - user.lastRefine < 2 * 60 * 60 * 1000) {
      const remaining = Math.ceil((2 * 60 * 60 * 1000 - (now - user.lastRefine)) / 3600000);
    ...
    if (success) {
      ...
      const availableArtifacts = this.artifacts.filter(a => 
        a.level <= user.realm && !user.artifacts.includes(a.id)
      );
  ...
  async cultivationBattle() {
    ...
    if (now - user.lastBattle < 5 * 60 * 1000) {
      const remaining = Math.ceil((5 * 60 * 1000 - (now - user.lastBattle)) / 1000);
    ...
    if (targetUser.equippedArtifact) {
      const artifact = this.artifacts.find(a => a.id === targetUser.equippedArtifact);
      if (artifact && artifact.type === "weapon") {
        targetPower *= 1.15;
      }
    }
    ...
    if (isUserWin) {
      ...
      resultMsg.push(
        `⚔️ ${this.e.sender.card || this.e.sender.nickname} 战胜了 ${this.e.at}`,
        `🏆 获得胜利奖励：`,
        `💎 灵石 +${baseReward}`,
        `✨ 修为 +${baseReward * 2}`,
        `⚔️ 战斗力 +10`
      ...
      resultMsg.push(
        `⚔️ ${this.e.sender.card || this.e.sender.nickname} 败给了 ${this.e.at}`,
        `💔 战败损失：`,
        `💎 灵石 -${baseLoss}`,
        `❤️ 生命值 -20`
      );
  ...
  async sectWar() {
    ...
    // 查找目标宗门
    const targetSectId = Object.keys(this.sects).find(id => 
      this.sects[id].name === targetSectName
    );
    ...
    for (let i = 0; i < 3; i++) {
      ...
      const attackerPower = attacker.combatPower * (1 + attacker.rebirthCount * 0.2);
      const defenderPower = defender.combatPower * (1 + defender.rebirthCount * 0.2);
    ...
    // 计算战争结果
    const warResult = attackerWins > defenderWins ? 
  ...
  async tribulationAssist() {
    ...
    // 发送互助请求
    await this.reply(
      `📢 ${this.e.at} 道友，${this.e.sender.card || this.e.sender.nickname} 愿助你渡劫！接受请回复 #接受互助`
    );
    ...
    targetUser.tribulationBoost = (targetUser.tribulationBoost || 0) + successRateBoost;
  ...
  async breakthrough() {
    ...
    if (user.exp < user.maxExp) {
      return this.reply(`❌ 修为不足！还需 ${user.maxExp - user.exp} 点修为方可突破`);
    }
    ...
    // 转世加成
    const rebirthBonus = user.rebirthBonus ? user.rebirthBonus.breakthrough * 20 : 0;
    
    const successRate = Math.max(10, 
      baseSuccessRate - realmPenalty + spiritRootBonus + luckBonus + daoHeartBonus + artBonus + artifactBonus + rebirthBonus
    );
  ...
  async tribulation() {
    ...
    if (user.exp < user.maxExp) {
      return this.reply(`❌ 修为不足！还需 ${user.maxExp - user.exp} 点修为方可渡劫`);
    }
    
    user.tribulationCount++;
    
    // 随机选择天劫类型
    const tribulationType = this.tribulations[Math.floor(Math.random() * this.tribulations.length)];
    ...
    // 转世加成
    const rebirthBonus = user.rebirthBonus ? user.rebirthBonus.tribulation * 20 : 0;
    
    const successRate = Math.min(95, baseSuccessRate + pillBonus + luckBonus + daoHeartBonus + artBonus + artifactBonus + assistBonus + rebirthBonus);
  ...
  async spiritRootTest() {
    ...
    if (user.spiritRoot > 0 && user.spiritRoot > 1) {
      return this.reply(`✨ 当前灵根：${this.spiritRoots[user.spiritRoot].name}（无需重复测试）`);
    }
  ...
  async seclusion() {
    ...
    if (now - user.lastSeclusion < 3 * 60 * 60 * 1000) {
      const remaining = Math.ceil((3 * 60 * 60 * 1000 - (now - user.lastSeclusion)) / 3600000);
  ...
  async comprehendArt() {
    ...
    // 随机选择未领悟的功法
    const availableArts = this.arts.filter(art => 
      !user.arts.includes(art.id)
    );
  ...
  async dualCultivation() {
    ...
    // 检查双方是否同意
    await this.reply(`📢 ${this.e.at} 道友，${this.e.sender.card || this.e.sender.nickname} 邀请你双修，同意请回复 #同意双修`);
    ...
    await this.reply([
      `💞 ${this.e.sender.card || this.e.sender.nickname} 与 ${this.e.at} 开始双修...`,
      `✨ 双方修为 +${expGain}`,
      `🍀 双方气运 +5`,
      `💖 阴阳调和，大道可期！`
    ].join('\n'));
  ...
  async forgeArtifact() {
    ...
    if (user.realm < artifact.level * 2) {
      return this.reply(`❌ 境界不足！需要 ${this.realms[artifact.level * 2]} 才能炼制 ${artifact.name}`);
    }
  ...
  async equipArtifact() {
    ...
    const artifact = this.artifacts.find(a => a.id === artifactId);
    await this.reply(`🔮 已装备法宝：${artifact.name}\n📊 效果：${artifact.effect}`);
  }
  ...
  async sectInfo() {
    ...
    if (sect.members.length > 0) {
      ...
      topMembers.forEach(member => {
        const title = this.sectTitles.find(t => t.id === member.title)?.name || '未知职位';
        msg.push(`  ${title} ${this.e.sender.card || this.e.sender.nickname} - ${this.realms[member.realm]}`);
      });
    }
  ...
  async joinSect() {
    ...
    if (user.sect) {
      return this.reply(`❌ 你已加入 ${this.sects[user.sect].name}，无法加入其他宗门`);
    }
    ...
    // 查找宗门
    const sectId = Object.keys(this.sects).find(id => 
      this.sects[id].name === sectName
    );
  ...
  async createSect() {
    ...
    if (user.sect) {
      return this.reply(`❌ 你已加入 ${this.sects[user.sect].name}，无法创建新宗门`);
    }
  ...
  async cultivationRank() {
    ...
    const userRank = users.findIndex(u => u.id === this.e.user_id) + 1 || '未上榜';
  ...
  async claimSalary() {
    ...
    const now = Date.now();
    const lastSalaryDate = user.lastSalary ? new Date(user.lastSalary).toDateString() : null;
    const today = new Date(now).toDateString();
  ...
  async viewInventory() {
    ...
    const pills = Object.keys(user.inventory)
      ...
      .map(id => {
        ...
        const pill = this.pills.find(p => p.id === pillId);
        return pill ? `💊 ${pill.name} [ID: ${id}] ×${user.inventory[id]}` : null;
      })
      .filter(Boolean);
    ...
    const others = Object.keys(user.inventory)
      ...
      .map(id => `🎁 ${this.getItemName(id)} [ID: ${id}] ×${user.inventory[id]}`);
  ...
  async cultivationShop() {
    const shopList = this.shopItems.map(item => 
      `${item.id}. ${item.name} - ${item.desc || '无描述'}\n  价格: ${item.price}灵石 | 类型: ${item.type} | 限购: ${item.limit || '无'}`
    ).join('\n\n');
  ...
  async buyItem() {
    ...
    if (shopItem.limit) {
      ...
      if (bought + quantity > shopItem.limit) {
        return this.reply(`❌ 超过购买限制，今日还可购买 ${shopItem.limit - bought} 个`);
      }
    }
    ...
    if (user.stone < totalPrice) {
      return this.reply(`❌ 灵石不足！需要 ${totalPrice} 灵石，当前只有 ${user.stone} 灵石`);
    }
  ...
  async realmSystem() {
    const realmList = this.realms.map((realm, index) => 
      `${index + 1}. ${realm}${index === 0 ? ' (初始境界)' : index === this.realms.length - 1 ? ' (最高境界)' : ''}`
    ).join('\n');
  ...
  async allTribulations() {
    const tribulationList = this.tribulations.map(t => 
  ...
  async sectList() {
    ...
    const sectList = Object.values(this.sects).map(sect => 
  ...
  async sectRank() {
    ...
    const rankedSects = Object.values(this.sects)
      .sort((a, b) => (b.level * 1000 + b.prestige) - (a.level * 1000 + a.prestige))
      .slice(0, 10);
    
    const sectList = rankedSects.map((sect, index) => 
      `${index + 1}. ${sect.name} (Lv.${sect.level}) ⭐${sect.prestige} - 成员: ${sect.members.length}人`
    ).join('\n');
  ...
  /** 查看法宝图鉴 */
  async viewArtifacts() {
    const artifactList = this.artifacts.map(a => 
  ...
  async sectManagement() {
    ...
    const match = this.e.msg.match(/^#宗门管理\s+(公告|解散|升级|传位)\s*(.*)$/);
    ...
    switch(command) {
      ...
      case '升级':
        ...
        if (sect.funds < cost) {
          return this.reply(`❌ 升级需要 ${cost} 灵石，当前资金: ${sect.funds}`);
        }
        sect.funds -= cost;
        sect.level += 1;
        this.saveData();
  ...
  async sectMission() {
    ...
    // 随机选择一个任务
    const mission = this.sectMissions[Math.floor(Math.random() * this.sectMissions.length)];
  ...
  async submitMission() {
    ...
    await this.reply([
      ...
      mission.difficulty === '地狱' ? `🎉 完成高难度任务${extraMsg}` : extraMsg
    ].filter(Boolean).join('\n'));
  }
  ...
  async tribulationInfo() {
    ...
    const successRate = Math.min(95, baseRate + pillBonus + luckBonus + daoHeartBonus + artBonus + artifactBonus + assistBonus + rebirthBonus);
